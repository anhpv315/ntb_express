...
class Notification {
  ...
  Notification({required this.id, required this.notificationGroup, required this.orderId, required this.customerId, required this.title,
      required this.body, this.read = 0, required this.insertTime});
