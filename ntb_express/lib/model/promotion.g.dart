...
Promotion _$PromotionFromJson(Map<String, dynamic> json) {
  return Promotion(
    promotionId: json['promotionId']== null? 0 : (json['promotionId'] as int),
    promotionName: json['promotionName'] ?? ''  as String,
    startDate: json['startDate']== null? null : (json['startDate'] as num),
    endDate: json['endDate']== null? null : (json['endDate'] as num),
    goodsType: json['goodsType']== null? null : (json['goodsType'] as int),
    promotionType: json['promotionType']== null? null : (json['promotionType'] as int),
    discountValue: (json['discountValue'] as num)?.toDouble(),
    maxDiscountValue: (json['maxDiscountValue'] as num)?.toDouble(),
    countOrder: json['countOrder']== null? null : (json['countOrder'] as int),
    ...
    compareType: json['compareType']== null? null : (json['compareType'] as int),
    maxUse: json['maxUse']== null? null : (json['maxUse'] as int),
